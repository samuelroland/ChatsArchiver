...
function viewlistchat($username)
{
    ...
    foreach ($chatinjson as $onechat) {
        ?>
        <div class="X7YrQ banchatleft"
             style="z-index: 8; transition: none 0s ease 0s; height: 72px; transform: translateY(0px);"><a
                    href="/?action=viewchat&chatid=<?= $onechat ?>">
                <div tabindex="-1">
                        ...
                        <div class="_2WP9Q">
                            ...
                            <div class="xD91K"><!-- last message info of the chat -->
                                <div class="_2Bw3Q"><span class="_1Wn_k"
                                                ...
                                                dir="ltr"
                                                class="_19RFN _1ovWX _F7Vk"><?= $onechat ?>Heureux d ...</span></span>
                                </div>
