...
$listofchats = viewlistchat($_SESSION['user']);
if (isset($thechatinfos)) {

    foreach ($thechatinfos as $msginrun) {
        var_dump($msginrun['type']);
        var_dump($msginrun['fileinfo']);
        $msginrun['msg'] = utf8_decode($msginrun['msg']);   //decode from the utf8 for display accents correctly

        if ($msginrun['author'] != "XtB12") {
